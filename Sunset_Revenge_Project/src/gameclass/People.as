package gameclass 
{
 ...
  		}
		...
		public function isTouchProjectile(p:String):gameclass.Projectile {
			return collide(p, x, y) as gameclass.Projectile;
		}
		
		public function isTouchFloor(p:String):gameclass.Platform{
			return collide(p, x, y) as gameclass.Platform;
		}
